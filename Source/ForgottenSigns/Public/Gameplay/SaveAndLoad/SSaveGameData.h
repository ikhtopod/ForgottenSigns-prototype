 ...
 */
USTRUCT(BlueprintType, Category = "Gameplay|SaveAndLoad")struct FORGOTTENSIGNS_API FSSaveGameData {
    GENERATED_USTRUCT_BODY()

public:
    // Game ID Name
    UPROPERTY(BlueprintReadWrite, Category = "SSaveGameData") FName id;

    // timestamp DateTime
    UPROPERTY(BlueprintReadWrite, Category = "SSaveGameData") FDateTime timestamp;

    // Saved actors array of SActorSaveData
    UPROPERTY(BlueprintReadWrite, Category = "SSaveGameData") TArray<FSActorSaveData> savedActors;
